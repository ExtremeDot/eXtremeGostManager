...
بعد از اینکه تانل رو برقرار کردید
روی سرور خارج گزینه ```88) Speed Test using iperf3``` رو بزنید

بعد از اون روی سرور ایران گزینه ```88) Speed Test using iperf3``` رو بزنید

شروع میکنه به تست گرفتن
اگه تونل برقرار باشه، اطلاعات مربوط به انتقال دیتا و سرعت انتقال رو بهتون نشون میده
